-- —оздаем последовательности дл€ генерации первичных ключей

-- дл€ таблицы attribute_type
create sequence attribute_type_seq
increment by 1
start with 1
cache 2;

-- дл€ таблицы object_type
...
-- создаем триггер дл€ таблицы object_type. ќн генерирует первичный ключ таблицы, если при добавление кортежа он отсутствует.
...
-- создаем таблицу attribute_type, в которой хран€тс€ метаданные по атрибутам
...
-- cоздаем триггер дл€ таблицы attribute_type. генерирует первичный ключ таблицы, если при добавление кортежа он отсутствует.
